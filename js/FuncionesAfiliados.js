...
function afiliados(){ 
    ...
    var  dt = $("#tabla").DataTable({
        "ajax": "php/Afiliados/ControladorAfiliados.php?accion=listar",
        "columns": [
            { "data": "id_afiliado"} ,
            { "data": "nom_afiliado" },
            { "data": "cedu_afiliado" }, 
...
$(".box-body").on("click","button#actualizar",function(){
     var datos=$("#fafiliados").serialize();
     $.ajax({
        type:"get",
        ...
        if(resultado.respuesta){    
          ...
          $(".box-title").html("Listado de Afiliados");
          $("#editar").html('');
...
$(".box-body").on("click","a.borrar",function(){
    ...
    swal({
          title: '¿Está seguro?',
          text: "¿Realmente desea borrar el afiliado con codigo : " + codigo + " ?",
          type: 'warning',
...
//se modifico el codigo para cargar el formulario de empleados 
  $(".box").on("click","#nuevo", function(){
    $(this).hide();
    $(".box-title").html("Crear Afiliado");
    $("#editar").addClass('show');
    $("#editar").removeClass('hide');
    $("#listado").addClass('hide');
    $("#listado").removeClass('show');
    $("#editar").load('./php/Afiliados/NuevoAfiliado.php', function(){
        $.ajax({
          type:"get",
...
$(".box-body").on("click","a.editar",function(){
   ...
   var sede;
   $(this).hide();
    $(".box-title").html("Actualizar Afiliados");
    $("#editar").addClass('show');
    $("#editar").removeClass('hide');
    $("#listado").addClass('hide');
    $("#listado").removeClass('show');  
   ...
   */
    ...
    $("#editar").load("./php/Afiliados/EditarAfiliado.php");
   ...
   $.ajax({
       ...
       dataType:"json"
       }).done(function( afiliados ) {        
            if(afiliados.respuesta === "no existe"){
                swal({
                  type: 'error',
                  title: 'Oops...',
                  text: 'afiliado no existe!!!!!'                         
                })
            } else {
                $("#id_afiliado").val(afiliados.codigo);                   
                $("#nom_afiliado").val(afiliados.nombre);  
                $("#cedu_afiliado").val(afiliados.cedula);                   
                $("#celu_afiliado").val(afiliados.celular);  
                $("#tipo_afiliacion").val(afiliados.tipoAfi);           
                sede = afiliados.sede;
            }
       });
