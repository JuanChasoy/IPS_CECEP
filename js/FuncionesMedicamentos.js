...
function medicamentos(){ 
    ...
    var  dt = $("#tabla").DataTable({
        "ajax": "php/Medicamentos/ControladorMedicamentos.php?accion=listar",
        "columns": [
            { "data": "id_medicamento"} ,
...
$(".box-body").on("click","button#actualizar",function(){
     var datos=$("#fmedicamento").serialize();
     $.ajax({
        type:"get",
        url:"./php/Medicamentos/ControladorMedicamentos.php",
        data: datos,
        dataType:"json"
...
//se modifico el codigo para cargar el formulario de empleados 
  $(".box").on("click","#nuevo", function(){
    ...
    $("#editar").load('./php/Medicamentos/NuevoMedicamento.php', function(){
       /* $.ajax({
          type:"get",
...
$(".box-body").on("click","a.editar",function(){
   ...
   */
    ...
    $("#editar").load("./php/Medicamentos/EditarMedicamento.php");
   ...
   $.ajax({
       ...
       dataType:"json"
            ...
            if(medicamento.respuesta === "no existe"){
                ...
                $("#id_medicamento").val(medicamento.codigo);                   
                $("#nom_medicamento").val(medicamento.medicamento);
