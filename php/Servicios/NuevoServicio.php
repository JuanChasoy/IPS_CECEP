        ...
        <div class="panel-group"><div class="panel panel-primary">
            ...
            <div class="panel-body">
                ...
                <form class="form-horizontal" role="form"  id="fservicios">
                    ...
                    <div class="form-group">
                        <label class="control-label col-sm-2" for="tipo_servicio">Tipos Servicio:</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="tipo_servicio" name="tipo_servicio" placeholder="Ingrese tipo servicio"
                            value = "">
                        </div>
                    </div>
