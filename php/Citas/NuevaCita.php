            ...
            <div class="panel-body">
                ...
                <form class="form-horizontal" role="form"  id="fcitas">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="nom_usu_cita" name="nom_usu_cita" placeholder="Ingrese Nombre de empleado"
                            value = "">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="correo_cita" name="correo_cita" placeholder="Ingrese direccion del empleado"
                            value = "">
                        </div>
                    </div>
